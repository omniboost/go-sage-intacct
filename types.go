...
type Bill struct {
	...
	VendorName                string    `xml:"VENDORNAME,omitempty"`
	State                     string    `xml:"STATE,omitempty"`
	RawState                  string    `xml:"RAWSTATE,omitempty"`
	WhenCreated               string    `xml:"WHENCREATED,omitempty"`
	WhenPosted                string    `xml:"WHENPOSTED,omitempty"`
	WhenPaid                  string    `xml:"WHENPAID,omitempty"`
	BillToPayToContactName    string    `xml:"BILLTOPAYTOCONTACTNAME,omitempty"`
	...
	Description               string    `xml:"DESCRIPTION,omitempty"`
	TermName                  string    `xml:"TERMNAME,omitempty"`
	RecPaymentDate            string    `xml:"RECPAYMENTDATE,omitempty"`
	SupDocID                  string    `xml:"SUPDOCID,omitempty"`
	WhenDue                   string    `xml:"WHENDUE,omitempty"`
	PaymentPriority           string    `xml:"PAYMENTPRIORITY,omitempty"`
	...
	InclusiveTax              bool      `xml:"INCLUSIVETAX,omitempty"`
	...
	MegaEntityName            string    `xml:"MEGAENTITYNAME,omitempty"`
	RecordURL                 string    `xml:"RECORD_URL,omitempty"`
	BillItems                 BillItems `xml:"APBILLITEMS>APBILLITEM"`
}
...
type BillItem struct {
	...
	OffsetGLAccountNo string             `xml:"OFFSETGLACCOUNTNO,omitempty"`
	TrxAmount         Number             `xml:"TRX_AMOUNT,omitempty"`
	TotalTrxAmount    Number             `xml:"TOTALTRXAMOUNT,omitempty"`
	EntryDescription  string             `xml:"ENTRYDESCRIPTION,omitempty"`
	Form1099          bool               `xml:"FORM1099,omitempty"`
	...
	WarehouseID       string             `xml:"WAREHOUSEID,omitempty"`
	PartialExempt     bool               `xml:"PARTIALEXEMPT,omitempty"`
	TaxEntries        BillItemTaxEntries `xml:"TAXENTRIES>TAXENTRY,omitempty"`
}

type BillItemTaxEntries []BillItemTaxEntry

type BillItemTaxEntry struct {
	DetailID string `xml:"DETAILID"`
	TrxTax   Number `xml:"TRX_TAX,omitempty"`
}

type APAdjustmentItems []APAdjustmentItem

type APAdjustmentItem struct {
	GLAccountNo       string     `xml:"glaccountno,omitempty"`
	AccountLabel      string     `xml:"accountlabel,omitempty"`
	OffsetGLAccountNo string     `xml:"offsetglaccountno,omitempty"`
	Amount            Number     `xml:"amount"`
	...
	LocationID        string     `xml:"locationid,omitempty"`
	DepartmentID      string     `xml:"departmentid,omitempty"`
	Item1099          bool       `xml:"item1099,omitempty"`
	Key               string     `xml:"key,omitempty"`
	ProjectID         string     `xml:"projectid,omitempty"`
	TaskID            string     `xml:"taskid,omitempty"`
	CostTypeID        string     `xml:"costtypeid,omitempty"`
...
func (i APAdjustmentItem) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	return omitempty.MarshalXML(i, e, start)
}

type APAdjustments []APAdjustment

type APAdjustment struct {
	RecordNo         string `xml:"RECORDNO,omitempty"`
	RecordType       string `xml:"RECORDTYPE,omitempty"`
	VendorID         string `xml:"VENDORID,omitempty"`
	VendorName       string `xml:"VENDORNAME,omitempty"`
...
type Vendor struct {
	...
	Form1099Type                         string  `xml:"FORM1099TYPE,omitempty"`
	Form1099Box                          string  `xml:"FORM1099BOX,omitempty"`
	APAccount                            string  `xml:"APACCOUNT,omitempty"`
	OffsetGLAccountNo                    string  `xml:"OFFSETGLACCOUNTNO,omitempty"`
	CreditLimit                          string  `xml:"CREDITLIMIT,omitempty"`
	RetainagePercentage                  string  `xml:"RETAINAGEPERCENTAGE,omitempty"`
	OnHold                               string  `xml:"ONHOLD,omitempty"`
	...
	Comments                             string  `xml:"COMMENTS,omitempty"`
	Currency                             string  `xml:"CURRENCY,omitempty"`
	PayMethodKey                         string  `xml:"PAYMETHODKEY,omitempty"`
	MergePaymentRequest                  string  `xml:"MERGEPAYMENTREQ,omitempty"`
	...
	ObjectRestriction                    string  `xml:"OBJECTRESTRICTION,omitempty"`
	RestrictedLocations                  string  `xml:"RESTRICTEDLOCATIONS,omitempty"`
	RestrictedDepartments                string  `xml:"RESTRICTEDDEPARTMENTS,omitempty"`
	IsIndividual                         string  `xml:"ISINDIVIDUAL,omitempty"`
	SupDocID                             string  `xml:"SUPDOCID,omitempty"`
	TotalDue                             string  `xml:"TOTALDUE,omitempty"`
	DefaultLeadTime                      string  `xml:"DEFAULT_LEAD_TIME,omitempty"`
	TaxSchedule                          string  `xml:"TAXSCHEDULE,omitempty"`
	TaxSolutionID                        string  `xml:"TAXSOLUTIONID,omitempty"`
	DisplayContactContactName            string  `xml:"DISPLAYCONTACT.CONTACTNAME,omitempty"`
	DisplayContactCompanyName            string  `xml:"DISPLAYCONTACT.COMPANYNAME,omitempty"`
	...
	DisplayContactMailAddressZip         string  `xml:"DISPLAYCONTACT.MAILADDRESS.ZIP,omitempty"`
	DisplayContactMailAddressCountry     string  `xml:"DISPLAYCONTACT.MAILADDRESS.COUNTRY,omitempty"`
	DisplayContactMailAddressCountryCode string  `xml:"DISPLAYCONTACT.MAILADDRESS.ISOCOUNTRYCODE,omitempty"`
	ContactInfoContactName               string  `xml:"CONTACTINFO.CONTACTNAME,omitempty"`
	ContactInfoPrefix                    string  `xml:"CONTACTINFO.PREFIX,omitempty"`
	ContactInfoFirstName                 string  `xml:"CONTACTINFO.FIRSTNAME,omitempty"`
	ContactInfoInitial                   string  `xml:"CONTACTINFO.INITIAL,omitempty"`
	...
	ContactInfoMailAddressZip            string  `xml:"CONTACTINFO.MAILADDRESS.ZIP,omitempty"`
	ContactInfoMailAddressCountry        string  `xml:"CONTACTINFO.MAILADDRESS.COUNTRY,omitempty"`
	ContactInfoMailAddressCountryCode    string  `xml:"CONTACTINFO.MAILADDRESS.ISOCOUNTRYCODE,omitempty"`
	PayToContactName                     string  `xml:"PAYTO.CONTACTNAME,omitempty"`
	PayToPrefix                          string  `xml:"PAYTO.PREFIX,omitempty"`
	PayToFirstName                       string  `xml:"PAYTO.FIRSTNAME,omitempty"`
	PayToLastName                        string  `xml:"PAYTO.LASTNAME,omitempty"`
	PayToInitial                         string  `xml:"PAYTO.INITIAL,omitempty"`
	PayToCompanyName                     string  `xml:"PAYTO.COMPANYNAME,omitempty"`
	PayToPrintAs                         string  `xml:"PAYTO.PRINTAS,omitempty"`
	PayToPhone1                          string  `xml:"PAYTO.PHONE1,omitempty"`
	PayToPhone2                          string  `xml:"PAYTO.PHONE2,omitempty"`
	PayToCellphone                       string  `xml:"PAYTO.CELLPHONE,omitempty"`
	PayToPager                           string  `xml:"PAYTO.PAGER,omitempty"`
	PayToFax                             string  `xml:"PAYTO.FAX,omitempty"`
	PayToEmail1                          string  `xml:"PAYTO.EMAIL1,omitempty"`
	PayToEmail2                          string  `xml:"PAYTO.EMAIL2,omitempty"`
	PayToURL1                            string  `xml:"PAYTO.URL1,omitempty"`
	PayToURL2                            string  `xml:"PAYTO.URL2,omitempty"`
	PayToVisible                         string  `xml:"PAYTO.VISIBLE,omitempty"`
	PayToMailAddressAddress1             string  `xml:"PAYTO.MAILADDRESS.ADDRESS1,omitempty"`
	PayToMailAddressAddress2             string  `xml:"PAYTO.MAILADDRESS.ADDRESS2,omitempty"`
	PayToMailAddressCity                 string  `xml:"PAYTO.MAILADDRESS.CITY,omitempty"`
	PayToMailAddressState                string  `xml:"PAYTO.MAILADDRESS.STATE,omitempty"`
	PayToMailAddressZip                  string  `xml:"PAYTO.MAILADDRESS.ZIP,omitempty"`
	PayToMailAddressCountry              string  `xml:"PAYTO.MAILADDRESS.COUNTRY,omitempty"`
	PayToMailAddressCountryCode          string  `xml:"PAYTO.MAILADDRESS.ISOCOUNTRYCODE,omitempty"`
	ReturnToContactName                  string  `xml:"RETURNTO.CONTACTNAME,omitempty"`
	ReturnToPrefix                       string  `xml:"RETURNTO.PREFIX,omitempty"`
	ReturnToFirstName                    string  `xml:"RETURNTO.FIRSTNAME,omitempty"`
	ReturnToLastName                     string  `xml:"RETURNTO.LASTNAME,omitempty"`
	ReturnToInitial                      string  `xml:"RETURNTO.INITIAL,omitempty"`
	ReturnToCompanyName                  string  `xml:"RETURNTO.COMPANYNAME,omitempty"`
	ReturnToPrintAs                      string  `xml:"RETURNTO.PRINTAS,omitempty"`
	ReturnToPhone1                       string  `xml:"RETURNTO.PHONE1,omitempty"`
	ReturnToPhone2                       string  `xml:"RETURNTO.PHONE2,omitempty"`
	ReturnToCellphone                    string  `xml:"RETURNTO.CELLPHONE,omitempty"`
	ReturnToPager                        string  `xml:"RETURNTO.PAGER,omitempty"`
	ReturnToFax                          string  `xml:"RETURNTO.FAX,omitempty"`
	ReturnToEmail1                       string  `xml:"RETURNTO.EMAIL1,omitempty"`
	ReturnToEmail2                       string  `xml:"RETURNTO.EMAIL2,omitempty"`
	ReturnToURL1                         string  `xml:"RETURNTO.URL1,omitempty"`
	ReturnToURL2                         string  `xml:"RETURNTO.URL2,omitempty"`
	ReturnToVisible                      string  `xml:"RETURNTO.VISIBLE,omitempty"`
	ReturnToMailAddressAddress1          string  `xml:"RETURNTO.MAILADDRESS.ADDRESS1,omitempty"`
	ReturnToMailAddressAddress2          string  `xml:"RETURNTO.MAILADDRESS.ADDRESS2,omitempty"`
	ReturnToMailAddressCity              string  `xml:"RETURNTO.MAILADDRESS.CITY,omitempty"`
	ReturnToMailAddressState             string  `xml:"RETURNTO.MAILADDRESS.STATE,omitempty"`
	ReturnToMailAddressZip               string  `xml:"RETURNTO.MAILADDRESS.ZIP,omitempty"`
	ReturnToMailAddressCountry           string  `xml:"RETURNTO.MAILADDRESS.COUNTRY,omitempty"`
	ReturnToMailAddressCountryCode       string  `xml:"RETURNTO.MAILADDRESS.ISOCOUNTRYCODE,omitempty"`
	WhenCreated                          string  `xml:"WHENCREATED,omitempty"`
	WhenModified                         string  `xml:"WHENMODIFIED,omitempty"`
	CreatedBy                            string  `xml:"CREATEDBY,omitempty"`
	ModifiedBy                           string  `xml:"MODIFIEDBY,omitempty"`
	DisplayContactKey                    string  `xml:"DISPLAYCONTACTKEY,omitempty"`
	ContactKey                           string  `xml:"CONTACTKEY,omitempty"`
	PayToKey                             string  `xml:"PAYTOKEY,omitempty"`
	ReturnToKey                          string  `xml:"RETURNTOKEY,omitempty"`
	ParentKey                            string  `xml:"PARENTKEY,omitempty"`
	TermsKey                             string  `xml:"TERMSKEY,omitempty"`
	AccountKey                           string  `xml:"ACCOUNTKEY,omitempty"`
	VendTypeKey                          string  `xml:"VENDTYPEKEY,omitempty"`
	GLGrpKey                             string  `xml:"GLGRPKEY,omitempty"`
	MegaEntityKey                        string  `xml:"MEGAENTITYKEY,omitempty"`
	MegaEntityID                         string  `xml:"MEGAENTITYID,omitempty"`
	MegaEntityName                       string  `xml:"MEGAENTITYNAME,omitempty"`
